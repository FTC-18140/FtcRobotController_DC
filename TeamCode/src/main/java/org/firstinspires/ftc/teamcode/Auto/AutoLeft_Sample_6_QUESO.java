...
@Autonomous
public class AutoLeft_Sample_6_QUESO extends LinearOpMode {
    ...
    public static Vector2d samplePos_Obs = new Vector2d(-27, -58);
                ...
                new SequentialAction(
                        ...
                        new ParallelAction(
                                robot.drive.actionBuilder(new Pose2d(basketPos, Math.toRadians(45)))
                                        .strafeToSplineHeading(samplePos_Obs, Math.toRadians(0))
                                        .build(),
                                ...
                                robot.intake.armDownAction(IntakeClaw.ARM_MAX_HORIZONTAL)
                        ),
                        robot.intake.wristMoveAction(IntakeClaw.WRIST_MAX),
                        new SleepAction(0.5),
                        ...
                        new ParallelAction(
                                robot.drive.actionBuilder(new Pose2d(samplePos_Obs, Math.toRadians(0)))
