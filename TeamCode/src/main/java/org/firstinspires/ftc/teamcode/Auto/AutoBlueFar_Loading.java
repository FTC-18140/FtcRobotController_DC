...
public class AutoBlueFar_Loading extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d preintakePos = new Pose2d(new Vector2d(AutoPositions.Positions.LOADING_ZONE_BLUE.position.x, 50), Math.toRadians(90));
                                            ...
                                            new SequentialAction(
                                                    ...
                                                    new RaceAction(
                                                            robot.drive.actionBuilder(launchPos)
                                                                    .splineTo(preintakePos.position, Math.toRadians(90))
                                                                    .splineTo(intakePos.position, Math.toRadians(90), new TranslationalVelConstraint(20))
                                                                    .build(),
