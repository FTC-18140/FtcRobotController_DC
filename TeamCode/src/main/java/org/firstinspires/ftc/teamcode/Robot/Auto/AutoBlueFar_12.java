                                            ...
                                            new SequentialAction(
                                                    ...
                                                    new RaceAction(
                                                            robot.drive.actionBuilder(launchPos)
                                                                    ...
                                                                    .splineToConstantHeading(new Vector2d(intakePos.position.x, 58), Math.toRadians(90), new TranslationalVelConstraint(30))
                                                                    .build(),
                                                    ...
                                                    new ParallelAction(
                                                            robot.drive.actionBuilder(new Pose2d(new Vector2d(intakePos.position.x, 58), Math.toRadians(90)))
                                                                    .setReversed(true)
                                                    ...
                                                    new RaceAction(
                                                            robot.drive.actionBuilder(launchPos)
                                                                    ...
                                                                    .splineToConstantHeading(new Vector2d(intakePos2.position.x, 58), Math.toRadians(90), new TranslationalVelConstraint(30))
                                                                    .build(),
                                                            robot.indexerFullAction()
                                                    ),
