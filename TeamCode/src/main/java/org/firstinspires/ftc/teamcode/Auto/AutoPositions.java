...
public class AutoPositions {
    ...
    public enum Positions {
        ...
        PARKING_LAUNCH_ZONE_BLUE(new Vector2d(35, 12)),
        CLOSE_LAUNCH_ZONE_RED(new Vector2d(32, -30)),
        CENTER_LAUNCH_ZONE_RED(new Vector2d(18, -16)),
        PARKING_LAUNCH_ZONE_RED(new Vector2d(35, -12)),
        ...
        LOADING_ZONE_BLUE(new Vector2d(-61,62)),
        LOADING_ZONE_RED(new Vector2d(-61,-62)),
