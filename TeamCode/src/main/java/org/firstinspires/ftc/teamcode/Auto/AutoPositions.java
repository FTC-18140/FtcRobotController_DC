...
public class AutoPositions {
    ...
    public enum Positions {
        ...
        ARTIFACT_CENTER_BLUE(new Vector2d(-34.5, 32)),
        ARTIFACT_CENTER_RED(new Vector2d(-34.5, -32)),
        ARTIFACT_GATE_BLUE(new Vector2d(12, 32)),
        ARTIFACT_GATE_RED(new Vector2d(12, -32)),
