...
public class AutoPositions {
    ...
    public enum Positions {
        ...
        CENTER_LAUNCH_ZONE_RED(new Vector2d(18.0, -16.0)),
        PARKING_LAUNCH_ZONE_RED(new Vector2d(35.0, -12.0)),
        ARTIFACT_BASE_BLUE(new Vector2d(-34.5, 26.0)),
        ARTIFACT_BASE_RED(new Vector2d(-34.5, -26.0)),
        ARTIFACT_CENTER_BLUE(new Vector2d(-10.0, 24.0)),
        ARTIFACT_CENTER_RED(new Vector2d(-10.0, -24.0)),
        ARTIFACT_GATE_BLUE(new Vector2d(13.5, 26.0)),
        ARTIFACT_GATE_RED(new Vector2d(13.5, -26.0)),
